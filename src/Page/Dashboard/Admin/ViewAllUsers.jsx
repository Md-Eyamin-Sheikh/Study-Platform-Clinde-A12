...
const ViewAllUsers = () => {
  ...
  const fetchUsers = async () => {
    try {
      const response = await fetch('https://study-hub-survar-a12-rtaxnv1a2-01775012014s-projects.vercel.app/admin/users');
      if (response.ok) {
  ...
  const updateUserRole = async (userId, newRole) => {
    try {
      const response = await fetch(`https://study-hub-survar-a12-rtaxnv1a2-01775012014s-projects.vercel.app/admin/users/${userId}/role`, {
        method: 'PATCH',
        headers: {
